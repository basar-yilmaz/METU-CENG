...
#			valE <- valB + valC
# Memory :
#			valM <- M_8[valE] (if invalid ADR)
# Write Back :
#
# PC Update :
#		PC <- invalid ? ADR : valM (exception)
#
#/* $begin seq-all-hcl */
####################################################################
...
# JTAB instruction added
bool instr_valid = icode in 
	{ INOP, IHALT, IRRMOVQ, IIRMOVQ, IRMMOVQ, IMRMOVQ,
	       IOPQ, IJXX, ICALL, IRET, IPUSHQ, IPOPQ, IJTAB };

# Does fetched instruction require a regid byte?
# yes, we need a regid byte for jtab instruction
bool need_regids =
	icode in { IRRMOVQ, IOPQ, IPUSHQ, IPOPQ, 
		     IIRMOVQ, IRMMOVQ, IMRMOVQ, IJTAB };

# Does fetched instruction require a constant word?
# yes, we need a constant word for jtab instruction
bool need_valC =
...
# we use constant rather than rA
word srcA = [
