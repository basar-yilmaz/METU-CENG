...
#################################################################
# Execute :
#			valE <- valB + valC  # aluA = valC, aluB = valB
# #################################################################
# Memory :
#			valM <- M_8[valE]	# exception check ADR
#################################################################
# Write Back : -
#################################################################
# PC Update :
...
##################################################################
# Story :
#	I realized that jtab instruction is similar to ret and irmovq
# 	instruction, in some sense. So I analyze the ret's pattern.
#	
#	When we first look the necessities of the jtab instruction:
#	- It needs the correct value of %rb register. 
#	- It needs the correct value of valE.
#	- It needs to predict the next value of PC by looking valM.
#
# 	In order to overcome this problem:
#   - I made the program "stall" in the fetch stage until the
#	  jtab instruction has reached its execute stage. By doing this,
#	  I made sure that the jtab calculated the correct value of valE.
#
#	- I injected "bubble" in the decode stage until the jtab instruction
#	  has reached its execute stage. By doing this, I made sure that the
# 	  consecutive instructions do not interfere with the jtab instruction,
#	  and these instruction get the updated value of valM.
#################################################################
#/* $begin pipe-all-hcl */
####################################################################
...
bool instr_valid = f_icode in 
	{ INOP, IHALT, IRRMOVQ, IIRMOVQ, IRMMOVQ, IMRMOVQ,
	  IOPQ, IJXX, ICALL, IRET, IPUSHQ, IPOPQ, IJTAB }; # added IJTAB
...
bool need_regids =
	f_icode in { IRRMOVQ, IOPQ, IPUSHQ, IPOPQ, 
	     IIRMOVQ, IRMMOVQ, IMRMOVQ, IJTAB }; # added IJTAB

# Does fetched instruction require a constant word?
bool need_valC =
f_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IJXX, ICALL, IJTAB }; # added IJTAB
...
word d_srcB = [
D_icode in { IOPQ, IRMMOVQ, IMRMOVQ, IJTAB } : D_rB; # added IJTAB
...
word aluA = [
	...
	E_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ , IJTAB} : E_valC; # added IJTAB
...
E_icode in { IRMMOVQ, IMRMOVQ, IOPQ, ICALL, 
		     IPUSHQ, IRET, IPOPQ, IJTAB } : E_valB; # added IJTAB
...
word mem_addr = [
	M_icode in { IRMMOVQ, IPUSHQ, ICALL, IMRMOVQ, IJTAB } : M_valE; # added IJTAB	
	M_icode in { IPOPQ, IRET } : M_valA;
	# Other instructions don't need address
];

## Set read control signal
bool mem_read = M_icode in { IMRMOVQ, IPOPQ, IRET, IJTAB }; # added IJTAB
...
bool F_stall =
	...
	IJTAB in { D_icode, E_icode, M_icode }; # added IJTAB
