...
public class Evaluation {
    ...
    public static void printAllTables(BufferedWriter bufferedWriter) throws IOException {
        ...
        try {
            ...
            for (int i = 0; i < tables.size(); i++) {
                ...
                while (rs.next()) {
                    bufferedWriter
                            .write(rs.getString(1) + " " + rs.getString(2) + System.getProperty("line.separator"));
                }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            /***********************************************************/
            fileWriter = FileOperations.createFileWriter(cengfactorydbDirectory + System.getProperty("file.separator")
                    + "output" + System.getProperty("file.separator") + "Output.txt");
            ...
            // insert WorksIn
            numberofInsertions = 0;
            WorksIn[] worksIns = FileOperations
                    .readWorksInFile(cengfactorydbDirectory + System.getProperty("file.separator")
            ...
            /***********************************************************/
            addDivider(bufferedWriter);
            addInputTitle("List the most profitable products for each factory",
                    bufferedWriter);
            try {
            ...
            /***********************************************************/
            addDivider(bufferedWriter);
            addInputTitle("List the most profit gaining factories for each product",
                    bufferedWriter);
            try {

                QueryResult.MostValueableProduct[] mostValueableProducts = cengfactoryDB
                        .getMostValueableProductsOnFactory();
            ...
            try {
                ...
                QueryResult.LowSalaryEmployees[] lowSalaryEmployees = cengfactoryDB
                        .getLowSalaryEmployeesForDepartments();
                // Header Line
            ...
            try {
                ...
                int numberofChanged = cengfactoryDB.increaseCost(updateProductType,
                        percentage);
